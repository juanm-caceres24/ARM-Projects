...
#define PWM_CYCLES 100 // Number of cycles (of SYSTICK_TIME_IN_US) to consider a PWM cycle (100 * 0.1[ms] = 10[ms])
...
void configUART() {
    ...
    UART_Init((LPC_UART_TypeDef *)LPC_UART0, &UARTConfigStruct); // Initialize UART0
